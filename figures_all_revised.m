...
%% Figure R4A, left - heatmap for ddw T(F5) G5FdU Anion

figure('units','normalized','outerposition',[0 0 1 1],Name="Fig R4A",NumberTitle="off");
set(gcf,'Color','w');

h3 = heatmap(seq_5p_dU,flip(seq_3p_dU),flip(ddw_T_F5_G5FdU_Anion_os_sort_by_pKa_heatmap),'CellLabelColor','none');
h3.MissingDataColor = [0.8 0.8 0.8];
h3.Colormap = earthyjet;
...
%% Figure R4B - correlation between ddw T(F5) G5FdU Anion and dpKa

x_data = ddw_T_F5_G5FdU_Anion_os_sort_by_pKa;
x_data_errs = ddw_T_F5_G5FdU_Anion_os_sort_by_pKa_errs;
y_data = dpKa_T_N3_G5FdU_Anion_os_sorted;
y_data_errs = dpKa_T_N3_G5FdU_Anion_os_sorted_errs;

[pKa_G5FdU_vs_F5_G5FdU_ddw_r,pKa_G5FdU_vs_F5_G5FdU_ddw_Rsq,pKa_G5FdU_vs_F5_G5FdU_ddw_Rsq_det,...
    pKa_G5FdU_vs_F5_G5FdU_ddw_rms,pKa_G5FdU_vs_F5_G5FdU_ddw_rms_per,...
    bestfit_ddw,x2_ddw,inBetween_ddw,...
    pKa_G5FdU_vs_F5_G5FdU_ddw_slope,pKa_G5FdU_vs_F5_G5FdU_ddw_inter,...
    pKa_G5FdU_vs_F5_G5FdU_ddw_slope_err,pKa_G5FdU_vs_F5_G5FdU_ddw_inter_err] = corr_plot(x_data,y_data,x_line,conf_int_per);

figure('units','normalized','outerposition',[0 0 1 1],Name="Fig R4B",NumberTitle="off");
set(gcf,'Color','w');

fill(x2_ddw, inBetween_ddw, 'k', 'FaceColor', color_shade_CI, 'FaceAlpha',.5,'LineStyle','none');
...
plot(x_line,bestfit_ddw,'k--','LineWidth',err_linewidth);

hold off;

text(-1.1,1.18,sprintf('r = %0.2f',pKa_G5FdU_vs_F5_G5FdU_ddw_r),'FontSize',fontsize,'FontWeight','bold');
text(-1.1,1.00,sprintf('RMSD = %0.2f',pKa_G5FdU_vs_F5_G5FdU_ddw_rms),'FontSize',fontsize,'FontWeight','bold');

axis([-1.45 1.3 -1.4 1.3]);

set(gca, 'FontSize', fontsize, 'XminorTick', 'on', 'YminorTick', 'on',...
    'XTick',-1.0:0.5:1.0,'YTick',-1.0:0.5:1.0,'LineWidth',axeswidth,...
    'TickLength',[ticksize,ticksize]);

xlabel('ddw G5FdU Anion-WB (ppm)', 'FontSize', font_title);
ylabel('dpKa', 'FontSize', font_title);

propedit;


%% Figure R4C - correlation between ddw T(F5) G5FdU Anion and pAnion at pH 7.4
...
pAnion_19F_pH_7p4_per = 100.*pAnion_19F_pH_7p4;
pAnion_19F_pH_7p4_per_errs = 100.*pAnion_19F_pH_7p4_errs;

dpAnion_19F_pH_7p4       = pAnion_19F_pH_7p4_per - pAnion_19F_pH_7p4_per(ismember(sorted_seqs_T_19F,ref_seq));
dpAnion_19F_pH_7p4_errs  = sqrt((pAnion_19F_pH_7p4_per_errs).^2 + (pAnion_19F_pH_7p4_per_errs(ismember(sorted_seqs_T_19F,ref_seq))).^2);

x_data = ddw_T_F5_G5FdU_Anion_os_sort_by_pKa;
x_data_errs = ddw_T_F5_G5FdU_Anion_os_sort_by_pKa_errs;
y_data = dpAnion_19F_pH_7p4;
y_data_errs = dpAnion_19F_pH_7p4_errs;

[dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_r,dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_Rsq,dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_Rsq_det,...
    dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_rms,dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_rms_per,...
    bestfit_ddw,x2_ddw,inBetween_ddw,...
    dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_slope,dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_inter,...
    dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_slope_err,dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_inter_err] = corr_plot(x_data,y_data,x_line,conf_int_per);
...
text(-1.1,1.18,sprintf('r = %0.2f',dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_r),'FontSize',fontsize,'FontWeight','bold');
text(-1.1,1.00,sprintf('RMSD = %0.2f',dpAnion_G5FdU_7p4_vs_F5_G5FdU_ddw_rms),'FontSize',fontsize,'FontWeight','bold');

axis([-1.45 1.3 -4 34]);

set(gca, 'FontSize', fontsize, 'XminorTick', 'on', 'YminorTick', 'on',...
    'XTick',-1.0:0.5:1.0,'LineWidth',axeswidth,...
    'TickLength',[ticksize,ticksize]);

xlabel('ddw G5FdU Anion-WB (ppm)', 'FontSize', font_title);
ylabel('dpAnion', 'FontSize', font_title);
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S8",NumberTitle="off");
set(gcf,'Color','w');
