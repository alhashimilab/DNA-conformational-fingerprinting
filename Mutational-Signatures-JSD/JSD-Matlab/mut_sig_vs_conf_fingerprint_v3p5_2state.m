...
if strcmp(dataset,'GT_Anion')
    ...
    filename   = 'Anion_populations_19F_1C_all_pHs_revised.xlsx';
    ...
    path_output           = 'Output-JSDs-v3p5/GT-anion-JSDs';
...
elseif strcmp(dataset,'AT_HG')
    ...
    path_output = 'Output-JSDs-v3p5/AT-HG-JSDs';
...
elseif strcmp(dataset,'GC_HG')
    ...
    path_output = 'Output-JSDs-v3p5/GC-HG-JSDs';
...
elseif strcmp(dataset,'AT_BaseOpening')
    ...
    path_output = 'Output-JSDs-v3p5/AT-Base-Open-JSDs';
...
filename_mut_sig = 'COSMIC_v3.5_SBS_GRCh37.txt';
