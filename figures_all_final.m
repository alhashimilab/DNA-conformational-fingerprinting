...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig 2B GT",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig 2B G5FdU",NumberTitle="off");
set(gcf,'Color','w');
...
filename_pops_19F   = 'Anion_populations_19F_1C_all_pHs_revised.xlsx';
...
ddw_T_F5_G5FdU_Anion_os_sort_by_pKa = dw_T_F5_G5FdU_Anion_os_sort_by_pKa - dw_T_F5_G5FdU_WB_os_sort_by_pKa;
ddw_T_F5_G5FdU_Anion_os_sort_by_pKa_errs = sqrt(dw_T_F5_G5FdU_Anion_os_sort_by_pKa_errs.^2 + dw_T_F5_G5FdU_WB_os_sort_by_pKa_errs.^2);
...
ddw_T_F5_G5FdU_Anion_os_sort_by_pKa_heatmap = NaN(4);
...
for i = 1:length(seq_mat)
    ...
    ddw_T_F5_G5FdU_Anion_os_sort_by_pKa_heatmap(seq_mat(i,1),seq_mat(i,2)) = ddw_T_F5_G5FdU_Anion_os_sort_by_pKa(i,1);
...
ddw_T_F5_G5FdU_Anion_os_sort_by_5p  = ddw_T_F5_G5FdU_Anion_os_sort_by_pKa(ind_5p);
...
[pWR_T_F5_G5FdU_ddw_3p,hWR_T_F5_G5FdU_ddw_3p] = ranksum(ddw_T_F5_G5FdU_Anion_os_sort_by_pKa(1:8),ddw_T_F5_G5FdU_Anion_os_sort_by_pKa(9:16));
[pWR_T_F5_G5FdU_ddw_5p,hWR_T_F5_G5FdU_ddw_5p] = ranksum(ddw_T_F5_G5FdU_Anion_os_sort_by_5p(1:8),ddw_T_F5_G5FdU_Anion_os_sort_by_5p(9:16));
...
% hold on;
% 
% plot(x1,dpKa_T_N3_G5FdU_Anion_os_sorted(1:8),'ko','MarkerSize',12,'MarkerFaceColor','k');
% plot(x2,dpKa_T_N3_G5FdU_Anion_os_sorted(9:16),'ko','MarkerSize',12,'MarkerFaceColor','k');
% 
% hold off;
% 
...
pHs_1D_19F_Low  = [6.88;6.84;6.87;7.01;6.88;6.91;6.92;6.82;...
    6.9;6.84;6.86;6.85;6.80;6.86;6.87;6.85];
...
pHs_1D_19F_Med2 = [NaN;NaN;8.96;8.91;9.22;NaN;8.95;9.055;...
    NaN;8.75;8.92;9.10;NaN;NaN;8.92;8.99];
...
%% Lorenzian fits - pH 6.8

filename_init_fit_params  = 'fitting-params-19F-nmr-20260113.xlsx';
filepath                  = sprintf('%s/%s',parent_path_1D_19F,filename_init_fit_params);

init_fit_params_Low = readtable(filepath,'Sheet','Low');
...
specs_1D_19F_Low_fits_params      = cell(height(specs_1D_19F_tbl),11);
specs_1D_19F_Low_fits_params(:,1) = specs_1D_19F_tbl.seq_T;

for i = 1:height(specs_1D_19F_tbl)

    if ~isnan(init_fit_params_Low.pH(i))

        spec_Low         = cell2mat(specs_1D_19F_tbl.Low(i));
        pH_Low           = pHs_1D_19F_Low(i);
        x_data_Low_all   = spec_Low(:,1);
        noise_region_Low = spec_Low(x_data_Low_all>noise_lims(2)&x_data_Low_all<noise_lims(1),2);
        noise_mean_Low   = mean(noise_region_Low);

        y_data_Low  = spec_Low(x_data_Low_all>(x_min_fits)&x_data_Low_all<x_max_fits,2) - noise_mean_Low;
        x_data_Low  = x_data_Low_all(x_data_Low_all>(x_min_fits)&x_data_Low_all<x_max_fits);

        if ismember('fit1Lorentzian',init_fit_params_Low.fitFunc(i))

            x0_WB_amp   = init_fit_params_Low.x0_WB_amp(i);
            x0_WB_width = init_fit_params_Low.x0_WB_width(i);
            x0_WB_cs    = init_fit_params_Low.x0_WB_cs(i);

            x0 = [x0_WB_amp x0_WB_width x0_WB_cs];

            [FitLorentzians_Low,resnorm_Low,exitflag_Low,output_Low,...
                FitLorentz2_Low,...
                cs_WB_Low] = fit1Lorentzian(x_data_Low, y_data_Low, x0, x_fit, pH_Low);
        ...
        elseif ismember('fit2LorentziansES1',init_fit_params_Low.fitFunc(i))

            x0_ES_amp   = init_fit_params_Low.x0_ES_amp(i);
            x0_ES_width = init_fit_params_Low.x0_ES_width(i);
            x0_ES_cs    = init_fit_params_Low.x0_ES_cs(i);
            x0_WB_amp      = init_fit_params_Low.x0_WB_amp(i);
            x0_WB_width    = init_fit_params_Low.x0_WB_width(i);
            x0_WB_cs       = init_fit_params_Low.x0_WB_cs(i);

            x0 = [x0_ES_amp x0_ES_width x0_ES_cs x0_WB_amp x0_WB_width x0_WB_cs];

            [FitLorentzians_Low,resnorm_Low,exitflag_Low,output_Low,...
                FitLorentz1_Low,FitLorentz2_Low,...
                pWB_Low,pES_Low,...
                cs_WB_Low,cs_ES_Low] = fit2LorentziansES1(x_data_Low, y_data_Low, x0, x_fit);
        ...
        elseif ismember('fit3Lorentzians',init_fit_params_Low.fitFunc(i))

            x0_anion_amp   = init_fit_params_Low.x0_anion_amp(i);
            x0_anion_width = init_fit_params_Low.x0_anion_width(i);
            x0_anion_cs    = init_fit_params_Low.x0_anion_cs(i);
            x0_WB_amp      = init_fit_params_Low.x0_WB_amp(i);
            x0_WB_width    = init_fit_params_Low.x0_WB_width(i);
            x0_WB_cs       = init_fit_params_Low.x0_WB_cs(i);
            x0_ES_amp      = init_fit_params_Low.x0_ES_amp(i);
            ...
            x0 = [x0_ES_amp x0_ES_width x0_ES_cs x0_WB_amp x0_WB_width x0_WB_cs x0_anion_amp x0_anion_width x0_anion_cs];

            [FitLorentzians_Low,resnorm_Low,exitflag_Low,output_Low,...
                FitLorentz1_Low,FitLorentz2_Low,FitLorentz3_Low,...
                pWB_Low,pES_Low,pAnion_Low,pKa_Low,...
                cs_WB_Low,cs_ES_Low,dcs_ES_Low,cs_Anion_Low] = fit3Lorentzians(x_data_Low, y_data_Low, x0, x_fit, pH_Low);


        elseif ismember('fit2LorentziansES1Const',init_fit_params_Low.fitFunc(i))
            ...
            lb = [-inf,x0_ES_width,-inf,-inf,-inf,-inf];
            ub = [inf,x0_ES_width,inf,inf,inf,inf];
          
            [FitLorentzians_Low,resnorm_Low,exitflag_Low,output_Low,...
                FitLorentz1_Low,FitLorentz2_Low,...
                pWB_Low,pES_Low,...
                cs_WB_Low,cs_ES_Low] = fit2LorentziansES1Const(x_data_Low, y_data_Low, x0, lb, ub, x_fit);
        ...
        specs_1D_19F_Low_fits_params{i,2} = FitLorentz3_Low;
        specs_1D_19F_Low_fits_params{i,3} = FitLorentz2_Low;
        specs_1D_19F_Low_fits_params{i,4} = FitLorentz1_Low;

        specs_1D_19F_Low_fits_params{i,5} = cs_WB_Low;
        specs_1D_19F_Low_fits_params{i,6} = cs_Anion_Low;
        specs_1D_19F_Low_fits_params{i,7} = cs_ES_Low;
        specs_1D_19F_Low_fits_params{i,8} = pWB_Low;
        specs_1D_19F_Low_fits_params{i,9} = pAnion_Low;
        specs_1D_19F_Low_fits_params{i,10} = pES_Low;
        specs_1D_19F_Low_fits_params{i,11} = pKa_Low;
...
for i = 1:height(specs_1D_19F_tbl)
    ...
    if init_fit_params_Low.used_in_plot(i) == 1

        specs_1D_19F_fits_plots{i,2}   = pHs_1D_19F_Low(i);
        specs_1D_19F_fits_plots(i,3:5) = specs_1D_19F_Low_fits_params(i,2:4);
        specs_1D_19F_fits_plots(i,6:8) = specs_1D_19F_Low_fits_params(i,8:10);
        specs_1D_19F_fits_plots(i,9)   = specs_1D_19F_tbl.Low(i);
     
    elseif init_fit_params_Low.used_in_plot(i) == 0

        specs_1D_19F_fits_plots(i,4)   = {zeros(1,1001)};
        specs_1D_19F_fits_plots(i,9)   = {zeros(1235,2)};

    end

end

%% Figure S6A - 1D 19F spectra at low pH with fits

scales_1D_19F_for_fits = [0.8; 1.5; 0.6; 1.0;...
    0.65; 1.05; 0.75; 0.65;...
    2.0; 0.9; 0.7; 1.0;...
    0.45; 0.95; 1.0; 0.5];
...
for i = 1:4
    ...
    if ~isempty(specs_1D_19F_fits_plots{i,3})
...
for i = 1:height(specs_1D_19F_tbl)
    ...
    if ~isnan(init_fit_params_Med1.pH(i))
        ...
        elseif ismember('fit3Lorentzians',init_fit_params_Med1.fitFunc(i))
            ...
            pAnion_3state     = pAnion_Med1(1);
            pAnion_3state_err = pAnion_Med1(2);
            pWB_3state        = pWB_Med1(1);
            pWB_3state_err    = pWB_Med1(2);
            pAnion_2state     = [100.*((pAnion_3state/pWB_3state)./(pAnion_3state/pWB_3state+1)),pAnion_3state_err];
            pWB_2state        = [100 - pAnion_2state,pWB_3state_err];
            pKa_2state        = pH_Med1 - log10(pAnion_2state(1)./(100-pAnion_2state(1)));
            pKa_2state_err    = 1/(log(10))*sqrt((pAnion_2state(2)./pAnion_2state(1)).^2+((pAnion_2state(2))./(100-pAnion_2state(1))).^2);

            pAnion_Med1       = pAnion_2state;
            pWB_Med1          = pWB_2state;
            pKa_Med1          = [pKa_2state,pKa_2state_err];
...
for i = 1:height(specs_1D_19F_tbl)
    ...
    if ~isnan(init_fit_params_Med2.pH(i))
        ...
        elseif ismember('fit3Lorentzians',init_fit_params_Med2.fitFunc(i))
            ...
            pAnion_3state     = pAnion_Med2(1);
            pAnion_3state_err = pAnion_Med2(2);
            pWB_3state        = pWB_Med2(1);
            pWB_3state_err    = pWB_Med2(2);
            pAnion_2state     = [100.*((pAnion_3state/pWB_3state)./(pAnion_3state/pWB_3state+1)),pAnion_3state_err];
            pWB_2state        = [100 - pAnion_2state,pWB_3state_err];
            pKa_2state        = pH_Med2 - log10(pAnion_2state(1)./(100-pAnion_2state(1)));
            pKa_2state_err    = 1/(log(10))*sqrt((pAnion_2state(2)./pAnion_2state(1)).^2+((pAnion_2state(2))./(100-pAnion_2state(1))).^2);

            pAnion_Med2       = pAnion_2state;
            pWB_Med2          = pWB_2state;
            pKa_Med2          = [pKa_2state,pKa_2state_err];
...
for i = 1:height(specs_1D_19F_tbl)
    ...
    if ~isnan(init_fit_params_Med3.pH(i))
        ...
        elseif ismember('fit3Lorentzians',init_fit_params_Med3.fitFunc(i))
            ...
            pAnion_3state     = pAnion_Med3(1);
            pAnion_3state_err = pAnion_Med3(2);
            pWB_3state        = pWB_Med3(1);
            pWB_3state_err    = pWB_Med3(2);
            pAnion_2state     = [100.*((pAnion_3state/pWB_3state)./(pAnion_3state/pWB_3state+1)),pAnion_3state_err];
            pWB_2state        = [100 - pAnion_2state,pWB_3state_err];
            pKa_2state        = pH_Med2 - log10(pAnion_2state(1)./(100-pAnion_2state(1)));
            pKa_2state_err    = 1/(log(10))*sqrt((pAnion_2state(2)./pAnion_2state(1)).^2+((pAnion_2state(2))./(100-pAnion_2state(1))).^2);

            pAnion_Med3       = pAnion_2state;
            pWB_Med3          = pWB_2state;
            pKa_Med3          = [pKa_2state,pKa_2state_err];
        ...
        elseif ismember('fit3LorentziansConst',init_fit_params_Med3.fitFunc(i))
            ...
            x0 = [x0_anion_amp x0_anion_width x0_anion_cs x0_WB_amp x0_WB_width x0_WB_cs x0_ES_amp x0_ES_width x0_ES_cs];
            lb = [x0_anion_amp,-inf,x0_anion_cs,-inf,-inf,-inf,-inf,x0_ES_width,x0_ES_cs];
            ub = [x0_anion_amp,inf,x0_anion_cs,inf,inf,inf,inf,x0_ES_width,x0_ES_cs];
...
%% Figure S6B - 1D 19F spectra at medium pH with fits
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6B 1",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6B 2",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6B 3",NumberTitle="off");
set(gcf,'Color','w');
...
for i = 9:12
    ...
    text(-163.9,(5E6-vert_offset_19F_1*i),sprintf('%0.0f%%',specs_1D_19F_fits_plots{i,6}(1)),...
        'FontSize',fontsize,'FontWeight','bold','Color',color_G5FdU_lowpH);

    text(-161.8,(5E6-vert_offset_19F_1*i),sprintf('%0.0f%%',specs_1D_19F_fits_plots{i,7}(1)),...
        'FontSize',fontsize,'FontWeight','bold','Color',color_G5FdU_Anion);
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6B 4",NumberTitle="off");
set(gcf,'Color','w');
...
for i = 1:length(temperature_19F_VT)
    ...
    pAnion_3state     = fitparams_CTC{i,11}(1);
    pAnion_3state_err = fitparams_CTC{i,11}(2);
    pWB_3state        = fitparams_CTC{i,10}(1);
    pWB_3state_err    = fitparams_CTC{i,10}(2);
    pAnion_2state     = [100.*((pAnion_3state/pWB_3state)./(pAnion_3state/pWB_3state+1)),pAnion_3state_err];
    pWB_2state        = [100 - pAnion_2state,pWB_3state_err];
    pKa_2state        = pH_CTC - log10(pAnion_2state(1)./(100-pAnion_2state(1)));
    pKa_2state_err    = 1/(log(10))*sqrt((pAnion_2state(2)./pAnion_2state(1)).^2+((pAnion_2state(2))./(100-pAnion_2state(1))).^2);

    fitparams_CTC{i,11} = pAnion_2state;
    fitparams_CTC{i,10} = pWB_2state;
    fitparams_CTC{i,13} = [pKa_2state,pKa_2state_err];
...
for i = 1:length(temperatures_ATC)
    ...
    pAnion_3state     = fitparams_ATC{i,11}(1);
    pAnion_3state_err = fitparams_ATC{i,11}(2);
    pWB_3state        = fitparams_ATC{i,10}(1);
    pWB_3state_err    = fitparams_ATC{i,10}(2);
    pAnion_2state     = [100.*((pAnion_3state/pWB_3state)./(pAnion_3state/pWB_3state+1)),pAnion_3state_err];
    pWB_2state        = [100 - pAnion_2state,pWB_3state_err];
    pKa_2state        = pH_ATC - log10(pAnion_2state(1)./(100-pAnion_2state(1)));
    pKa_2state_err    = 1/(log(10))*sqrt((pAnion_2state(2)./pAnion_2state(1)).^2+((pAnion_2state(2))./(100-pAnion_2state(1))).^2);

    fitparams_ATC{i,11} = pAnion_2state;
    fitparams_ATC{i,10} = pWB_2state;
    fitparams_ATC{i,13} = [pKa_2state,pKa_2state_err];

end


%% Figure S6E - 1D 19F VT, offset vertically, CTC and ATC

scale_5FdU = 7;

figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6E left",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6E right",NumberTitle="off");
set(gcf,'Color','w');
...
%% Figure S6D - GTA and TTT - pKa at different pHs

[~,ind_GTA] = ismember('GTA',specs_1D_19F_tbl.seq_T);

figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6D left 1",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6D left 2",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6D right 1",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S6D right 2",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B GTA U 13C",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B GTA U 1H",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B GTA G 13C",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B GTA G 1H",NumberTitle="off");
set(gcf,'Color','w');
...
bar_vals_ATT = [ATT_neigh_G5FdU_vs_GT([2,1,3,5,4,6],1:7)];


figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B ATT U 13C",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B ATT U 1H",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B ATT G 13C",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B ATT G 1H",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B CTG U 13C",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B CTG U 1H",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B CTG G 13C",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S2B CTG G 1H",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig 3D left",NumberTitle="off");
set(gcf,'Color','w');
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig 3D right",NumberTitle="off");
set(gcf,'Color','w');
...
%% Figure S7 - ddG Anion vs. ddG melt (GC)

x_data      = ddG_melt_GC_25C;
x_data_errs = ddG_melt_GC_25C_errs;
y_data      = ddG_Anion_19F_7p4_1C(ind_dG_melt);
y_data_errs = ddG_Anion_19F_7p4_1C_errs(ind_dG_melt);

[ddG_Anion_19F_vs_ddG_melt_GC_r,ddG_Anion_19F_vs_ddG_melt_GC_Rsq,ddG_Anion_19F_vs_ddG_melt_GC_Rsq_det,...
    ddG_Anion_19F_vs_ddG_melt_GC_rms,ddG_Anion_19F_vs_ddG_melt_GC_rms_per,...
    ddG_Anion_19F_vs_ddG_melt_GC_bestfit,x2_ddG,inBetween_ddG,...
    ddG_Anion_19F_vs_ddG_melt_GC_slope,ddG_Anion_19F_vs_ddG_melt_GC_inter,...
    ddG_Anion_19F_vs_ddG_melt_GC_slope_err,ddG_Anion_19F_vs_ddG_melt_GC_inter_err] = corr_plot(x_data,y_data,x_line,conf_int_per);
...
errorbar(x_data,y_data,y_data_errs,y_data_errs,...
    x_data_errs,x_data_errs,...
    'o','MarkerEdgeColor',color_GC,'MarkerFaceColor',color_GC,'MarkerSize',markersize_ddG,...
    'Color',color_GC,'CapSize',err_capsize,'Linewidth',axeswidth);

hold on;

plot(x_line,ddG_Anion_19F_vs_ddG_melt_GC_bestfit,'k--','LineWidth',2);
...
text(-5.2,2.6,sprintf('RMSD = %0.1f kcal/mol',ddG_Anion_19F_vs_ddG_melt_GC_rms),'FontSize',fontsize,'FontWeight','bold');
text(-5.2,2.4,sprintf('r = %0.2f',ddG_Anion_19F_vs_ddG_melt_GC_r),'FontSize',fontsize,'FontWeight','bold');

xlabel('DDDG melt (GC)', 'FontSize', 36);
ylabel('DDG Anion', 'FontSize', 36);
...
%% Figure S9 - pAnion and pTautomer vs. sequence
...
pKas_diffs              = pKas_prev_High_pH_10C_DNA - sorted_pKas_19F(ind_dG_R1rho);
pKas_diffs_errs         = sqrt(pKas_prev_High_pH_10C_DNA_errs.^2 + (sorted_pKas_19F_errs(ind_dG_R1rho)).^2);

pKas_diff_average       = mean(pKas_diffs);
pKas_diff_stdv          = std(pKas_diffs);
...
figure('units','normalized','outerposition',[0 0 1 1],Name="Fig S9",NumberTitle="off");
set(gcf,'Color','w');
...
set(gca, 'FontSize', fontsize, 'XTick', 1:17, 'YTick',0:0.1:0.3,...
    'XminorTick', 'off', 'YminorTick', 'on','LineWidth',axeswidth,...
    'TickLength',[ticksize,ticksize]);
