function [Fit2Lorentzians,resnorm,exitflag,output,Lorentz1_2,Lorentz2_2,p_WB_2L,p_Anion_2L,pKa_2L,cs_WB_2L,cs_Anion_2L,dcs_Anion_2L] = fit2LorentziansConst(x_data, y_data, initParams, lb, ub, x_fit, pH)
