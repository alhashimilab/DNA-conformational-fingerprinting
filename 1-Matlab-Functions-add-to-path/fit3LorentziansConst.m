function [Fit3Lorentzians,resnorm,exitflag,output,Lorentz1_3,Lorentz2_3,Lorentz3_3,p_WB_3L,p_Anion_3L,p_ES_3L,pKa_3L,cs_WB_3L,cs_Anion_3L,dcs_Anion_3L,cs_ES_3L] = fit3LorentziansConst(x_data, y_data, initParams, lb, ub, x_fit, pH)
...
[fit3Params,resnorm,resid,exitflag,output,lambda,Jacobian] = lsqcurvefit(F_3_lorentzians,initParams,x_data,y_data,lb,ub);
...
%pKa_err_2 = 1/(log(10))*sqrt((p_Anion(1,2)./p_Anion(1,1)).^2+((p_Anion(1,2))./(100-p_Anion(1,1))).^2);
